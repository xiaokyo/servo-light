...
// 空调开关小爱同学
void miotmode_kongtiao(uint8_t mode)
{
...
void setup()
{
  ...
  button_open_kongtiao.attach(open_kongtiao_handler);
  button_close_kongtiao.attach(close_kongtiao_handler);
  BlinkerMIOT.attachPowerState(miotPowerState);
  BlinkerMIOT.attachMode(miotmode_kongtiao);
